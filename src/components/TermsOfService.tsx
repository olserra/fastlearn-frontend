  ...
  <div className="px-4 md:px-12 mx-auto max-w-screen-xl text-center lg:px-6">
    <div className="mx-auto mt-12">
      ...
      <p className="text-sm text-gray-500 max-w-4xl">
        ...
        damages arising out of your use or inability to use our Site or
        services. 5. Governing Law: These Terms of Service shall be governed by
        and construed in accordance with the laws of [Jurisdiction]. Any legal
        action or proceeding arising out of or related to these Terms of Service
        shall be brought exclusively in the courts of [Jurisdiction]. 6.
        Modifications: We may update or modify these Terms of Service from time
        to time. Any changes will be effective upon posting on this Site. Your
